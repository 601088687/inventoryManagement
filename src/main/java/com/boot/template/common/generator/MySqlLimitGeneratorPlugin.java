...
/**
 * 在利用Example类查询数据是通过"limit"和"offset"语句只查询部分数据。 通常用于分页查找。
 *
 * @author hanningning
 */
public class MySqlLimitGeneratorPlugin extends PluginAdapter {
  ...
  public boolean modelExampleClassGenerated(
    ...
    PrimitiveTypeWrapper integerWrapper =
  ...
  private XmlElement limitXmlElement() {
